...
class ExportKeymapAction extends AnAction implements DumbAware {
    ...
    public void actionPerformed(AnActionEvent e) {
        ...
        if (settings.keymapName == null)
            settings.keymapName = KeymapManagerEx.instanceEx.activeKeymap.presentableName
        ...
        def dialog = new DialogWrapper(PlatformDataKeys.PROJECT.getData(e.dataContext)) {
            ...
            @Override
            protected JComponent createCenterPanel() { content }
        }
        ...
        if (Desktop.isDesktopSupported()) {
            try {
                ...
                showError(Bundle.message('error.cannot.open'))
            }
        }
    }
